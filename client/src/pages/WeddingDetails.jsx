  ...
  return (
    <div className="min-h-screen bg-stone-50 font-serif text-stone-900 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="flex-1 flex flex-col overflow-hidden px-8 py-6 border-r border-stone-200">
          <h2 className="text-lg font-bold text-stone-700 mb-4 flex items-center gap-2 flex-shrink-0">
            Registry Items
          ...
          {error && (
            <p className="text-red-600 text-sm mb-4 bg-red-50 border border-red-200 rounded-md px-3 py-2 font-sans flex-shrink-0">
              {error}
            </p>
          )}
          ...
          {registryLoading ? (
            ...
            <ul className="space-y-3 overflow-y-auto max-h-[calc(100vh-12rem)] pr-1">
